...
<link href="resources/css/columnDivider.css" rel="stylesheet" type="text/css">
					...
					<ul class="nav navbar-nav">
						<li class="dropdown mega-dropdown"><a href="#"
							...
							<ul class="dropdown-menu mega-dropdown-menu">
								<li class="col-sm-3">
									<ul>
										<li class="dropdown-header">FirstCompany</li>
								...
								<li class="col-sm-3">
									<ul>
										<li class="dropdown-header">SecondCompany</li>
										<li><a href="#">Product 1</a></li>
										<li><a href="#">Product 2</a></li>
										<li><a href="#">Product 3</a></li>
										<li><a href="#">Product 4</a></li>
								...
								<li class="col-sm-3">
									<ul>
										<li class="dropdown-header">ThirdCompany</li>
										<li><a href="#">Product 1</a></li>
										<li><a href="#">Product 2</a></li>
										<li><a href="#">Product 3</a></li>
										<li><a href="#">Product 4</a></li>
